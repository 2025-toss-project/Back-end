package payroad.global.security.filter;

import static payroad.global.response.status.ErrorStatus.AUTHENTICATION_TYPE_IS_NOT_BEARER;
import static payroad.global.response.status.ErrorStatus.TOKEN_IS_EXPIRED;
...
//        RoleType roleType = RoleType.valueOf(jwtUtil.getRoleType(jwtToken));
        ...
        // 나중에 사용자의 역할이 주어지고 권한을 사용하려면 List에 추가
