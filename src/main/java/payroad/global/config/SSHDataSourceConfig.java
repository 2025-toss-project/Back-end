...
@EnableJpaRepositories(basePackages = {
    "payroad.domain.budget.repository",
    "payroad.domain.category.repository",
    "payroad.domain.member.repository",
    "payroad.domain.consumption.repository",
    "payroad.domain.map.repository"
})
